...
// ═══════════════════════════════════════════════
//  РЕАКЦИИ СЕРГЕЯ
//  Эмодзи-палитра: Сергей может ставить реакцию на записи
//  в логе, инициатором которых был НЕ он сам.
// ═══════════════════════════════════════════════
export const REACTION_EMOJIS = ["🐷", "🔥", "🎉", "❤️", "👍🏻", "👎🏻"];

// Типы событий лога, инициатором которых является САМ Сергей —
// реагировать на них нельзя (он же сам их и создал).
export const OWN_ACTION_TYPES = ["submit", "cancel", "buy", "tier"];
